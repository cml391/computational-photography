...
def test_findCorrespondence():
  im1=io.imread('pano/my-photo-1.png', 1.0)
  im2=io.imread('pano/my-photo-2.png', 1.0)
...
def test_my_autostitch():
  im1=io.imread('pano/my-photo-1.png', 1.0)
  im2=io.imread('pano/my-photo-2.png', 1.0)
  im3=io.imread('pano/my-photo-3.png', 1.0)
  im_list=[im1, im2, im3]
  out=a7.autostitch(im_list, 1) 
  io.imwrite(out, 'myPanorama.png', 1.0)
def test_weight_map():
  w_map = a7.weight_map(75, 50)
  io.imwrite(w_map, 'weightmap.png', 1.0)
...
def test_my_linear_blending():
  im1=io.imread('pano/my-photo-1.png', 1.0)
  im2=io.imread('pano/my-photo-2.png', 1.0)
  im3=io.imread('pano/my-photo-3.png', 1.0)
  im_list=[im1, im2, im3]
  out=a7.linear_blending(im_list, 1) 
  io.imwrite(out, 'myLinearBlendingPano.png', 1.0)
...
def test_my_two_scale_blending():
  im1=io.imread('pano/my-photo-1.png', 1.0)
  im2=io.imread('pano/my-photo-2.png', 1.0)
  im3=io.imread('pano/my-photo-3.png', 1.0)
  im_list=[im1, im2, im3]
  out=a7.two_scale_blending(im_list, 1) 
  io.imwrite(out, 'myTwoScaleBlendingPano.png', 1.0)
...
#test_my_linear_blending()
#test_two_scale_blending()
#test_two_scale_blending2()
test_my_two_scale_blending()
